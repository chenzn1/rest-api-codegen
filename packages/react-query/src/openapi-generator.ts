...
interface OpenApiReactQueryGeneratorOptions {
  schema: string
  fetcher: string
  output: string
  name: string
...
export class OpenApiReactQueryGenerator {
  ...
  constructor({ schema, fetcher, output, name }: OpenApiReactQueryGeneratorOptions) {
    this.schema = schema;
